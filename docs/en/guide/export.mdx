...
![Multi-channel mask image](/polygon-mask-segmentation.png)

Single-channel mask image:

![Single-channel mask image](/polygon-mask-trainids.png)
...
![Label Configuration](/pascal-voc-config.png)

Annotation effect:
![Annotation Effect](/pascal-voc-annotation.png)
:::
