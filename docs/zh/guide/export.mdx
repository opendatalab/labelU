...
![polygon-annotation-mask](/zh/polygon-annotation.png)
...
![多通道 mask 图片](/zh/polygon-mask-segmentation.png)

单通道 mask 图片：

![单通道 mask 图片](/zh/polygon-mask-trainIds.png)
...
配置如图：
![标签配置](/zh/pascal-voc-config.png)

标注效果：
![标注效果](/zh/pascal-voc-annotation.png)
:::
