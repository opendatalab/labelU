...
- Image-based: A multifunctional image processing tool that includes various annotation tools such as bounding boxes, point marking, line marking, polygons, and 3D boxes, assisting in the identification, annotation, and analysis of images.
